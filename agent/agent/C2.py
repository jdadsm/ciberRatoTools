...
class MyRob(CRobLinkAngs):
    ...
    def get_left_buffer_paths(self,buffer,exact_sensor):
        ...
        if self.is_sublist_of(buffer,[['0', '0'], ['0', '1'], ['1', '1']]) or self.is_sublist_of(buffer, [['1', '1'], ['1', '0']]) or self.is_sublist_of(buffer, [['0', '1'], ['1', '1']]):
            paths.append(135+exact_sensor)
        if self.is_sublist_of(buffer,[['0', '0'], ['1', '1'], ['0', '1']])  or self.is_sublist_of(buffer,[['1', '1'], ['0', '1']]) or self.is_sublist_of(buffer, [['1', '0'], ['1', '1']]):
    ...
    def get_right_buffer_paths(self,buffer,exact_sensor):
        ...
        if self.is_sublist_of(buffer,[['0','0'],['1','1']]):
            paths.append(-90+exact_sensor)
        if self.is_sublist_of(buffer,[['0', '0'], ['1', '0'], ['1', '1']]) or self.is_sublist_of(buffer, [['1', '1'], ['0', '1']]) or self.is_sublist_of(buffer, [['1', '0'], ['1', '1']]):
            paths.append(-135+exact_sensor)
        if self.is_sublist_of(buffer,[['0', '0'], ['1', '1'], ['1', '0']]) or self.is_sublist_of(buffer,[['1', '1'], ['1', '0']]) or self.is_sublist_of(buffer, [['0', '1'], ['1', '1']]):
            paths.append(-45+exact_sensor)
